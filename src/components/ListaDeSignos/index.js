    ...
    return(
        <div>
            ...
            <div className="Lista">
                ...
                <ItemLista signo="Gemeos"   dataInicio="22/05"  dataFim="21/06" imagem="./assets/gemeos.jpg" />
                <ItemLista signo="Cancer"   dataInicio="22/06"  dataFim="23/07" imagem="./assets/cancer.jpg" />
